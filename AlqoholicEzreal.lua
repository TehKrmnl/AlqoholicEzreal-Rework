...
local LvLOrder = {
        [1] = { HK_Q, HK_E, HK_Q, HK_W, HK_Q, HK_R, HK_Q, HK_E, HK_Q, HK_E, HK_R, HK_E, HK_E, HK_W, HK_W, HK_R, HK_W, HK_W },
        ...
        [9] = { HK_Q, HK_E, HK_Q, HK_W, HK_Q, HK_R, HK_Q, HK_E, HK_Q, HK_E, HK_R, HK_E, HK_E, HK_W, HK_W, HK_R, HK_W, HK_W },
}
local LvLSlot = nil
local LvLTick = 0
...
local CurrentOrbName = function()
        ...
        if _G.SDK then
        	orb = "IC's Orbwalker"
        elseif _G.Orbwalker then
        	orb = "Noddy's Orbwalker, I recommend using IC's Orbwalker with this"
        end
        return orb
end
...
local Load = function()   
        ...
        Menu = MenuElement({type = MENU, name = "AlqoholicEzrealFIX",  id = "AlqoholicEzrealFIX", leftIcon = "https://cdn.discordapp.com/emojis/249237025754972171.png"})
        ...
        Menu.JungleClear:MenuElement({type = MENU, name = "[W] Essence Flux",  id = "W"})
        ...
        Menu.Draw:MenuElement({type = MENU, name = "[R] Trueshot Barrage",  id = "R"})
        ...
        Menu:MenuElement({name = "League Version", drop = {"7.8 29/04/2017"}})
        Menu:MenuElement({name = "Author", drop = {"Alqoholic - Credit to Shepulin for the Idea"}})
        ...
        print(" Loaded | Current orbwalker: "..CurrentOrbName())         
end 
